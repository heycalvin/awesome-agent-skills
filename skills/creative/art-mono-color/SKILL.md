---
name: art-mono-color
description: Generate original one-ink or controlled two-ink editorial images from any theme, sentence, article idea, object, or reference photo. Trigger on art-mono-color, mono-color, 单色海报, 双色印刷, 单色调视觉, 蓝色/绿色孔版印刷, risograph, 网点照片, 复古或当代编辑排版, zine poster, monochrome editorial poster, or duotone print.
---

# Art Mono Color (Monocolor Editorial Print)

> **Origin / Upstream**: Adapted from [yanliudesign/mono-color-skill](https://github.com/yanliudesign/mono-color-skill) by @yanliudesign (MIT License).
